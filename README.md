...
#app > div.interface.text-2 > div.background {
    background: url(https://wallpaper.dog/large/20353730.jpg) center top/cover no-repeat;
    animation: loopPattern 80s linear infinite;
}

.end-modal {
    background: url(https://wallpaper.dog/large/20353730.jpg) repeat !important;
}

#app > div.interface.text-2 > div.background > div.pattern-bg {
    background: url(https://wallpaper.dog/large/20353730.jpg) !important;
    opacity: 1;
    animation: none;
}
...
#right-interface > div.settings-and-socicons > div:nth-child(2) {
    background: transparent !important;
    border: none;
}
...
body:before {
    ...
    background-size: var(--X-px), var(--Y-px);
    height: var(--Y-px);
    width: var(--X-px);
    content: "";
    position: fixed;
